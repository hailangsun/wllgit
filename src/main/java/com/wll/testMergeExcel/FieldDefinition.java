...
public class FieldDefinition implements Serializable {
    ...
    public FieldDefinition(String name, String property, String convertName) {
        this.name = name;
        this.property = property;
        this.convertName = convertName;
    }

    public FieldDefinition(String name, String property, String convertName, String convertParams, int order) {
        this.name = name;
        this.property = property;
        this.convertName = convertName;
