...
package com.wll.demo.Excel4j;

import com.wll.demo.Excel4j.converter.DefaultConvertible;
import com.wll.demo.Excel4j.exceptions.Excel4JException;
import com.wll.demo.Excel4j.exceptions.Excel4jReadException;
...
import com.wll.demo.Excel4j.sheet.wrapper.MapSheetWrapper;
import com.wll.demo.Excel4j.sheet.wrapper.NoTemplateSheetWrapper;
import com.wll.demo.Excel4j.sheet.wrapper.NormalSheetWrapper;
import com.wll.demo.Excel4j.sheet.wrapper.SimpleSheetWrapper;
 ...
 * 1.读取Excel操作基于注解映射,handler为{@link com.wll.demo.Excel4j.ExcelUtils#readExcel2ObjectsHandler}<br>
 * 2.读取Excel操作无映射,handler为{@link com.wll.demo.Excel4j.ExcelUtils#readExcel2ObjectsHandler}<br>
 * 3.基于模板、注解导出excel,handler为{@link com.wll.demo.Excel4j.ExcelUtils#exportExcelByModuleHandler}<br>
 * 4.基于模板、注解导出Map数据,handler为{@link com.wll.demo.Excel4j.ExcelUtils#exportExcelByModuleHandler}<br>
 * 5.无模板基于注解导出,handler为{@link com.wll.demo.Excel4j.ExcelUtils#exportExcelByMapHandler}<br>
 * 6.无模板无注解导出,handler为{@link com.wll.demo.Excel4j.ExcelUtils#exportExcelBySimpleHandler}<br>
 * <p>
...
public final class ExcelUtils {
     ...
     * 双检锁保证单例
     */
    public static com.wll.demo.Excel4j.ExcelUtils getInstance() {
        if (null == excelUtils) {
            synchronized (com.wll.demo.Excel4j.ExcelUtils.class) {
                if (null == excelUtils) {
                    excelUtils = new com.wll.demo.Excel4j.ExcelUtils();
                }
            }
        }
        return excelUtils;
     ...
     * @param clazz      待绑定的类(绑定属性注解{@link com.wll.demo.Excel4j.annotation.ExcelField})
    ...
    /**
     * 基于Excel模板与注解{@link com.wll.demo.Excel4j.annotation.ExcelField}导出Excel
     *
    ...
    /**
     * 基于Excel模板与注解{@link com.wll.demo.Excel4j.annotation.ExcelField}导出多sheet的Excel
     *
     ...
     *
     * @param data          待导出数据
     * @param clazz         {@link com.wll.demo.Excel4j.annotation.ExcelField}映射对象Class
     * @param isWriteHeader 是否写入表头
